...
public class FabricaGhostOrange extends FabricaActores {

    private Texture[] ghostOrange;
    private Texture [] ghostMiedoMuerte;
    private Ghost naranja;


    public FabricaGhostOrange(AssetManager manager) {
        super(manager);
    }
    ...
    public Actor crearActor(World myWorld, Vector2 posicion, Object map) {
        ...
        naranja = new Ghost(myWorld, ghostOrange, ghostMiedoMuerte, posicion,
    ...
    public void setRecorrido(int numRecorrido){
        this.naranja.setRecorrido(numRecorrido);
    }
}
